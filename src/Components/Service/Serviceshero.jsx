...
export default function ServicesHero() {
  return (
    <section className="relative bg-gradient-to-br from-[#000428] via-[#001845] to-[#004e92] overflow-hidden pt-32 pb-24">
      ...
      />
      <div className="absolute -top-24 -left-24 w-[26rem] h-[26rem] bg-[#0072c6]/15 rounded-full blur-3xl" />
      ...
      <div className="relative max-w-5xl mx-auto px-6">
        <motion.div initial="hidden" animate="show" variants={fadeUp}>
          ...
          <h1 className="font-bold text-4xl sm:text-5xl text-white leading-tight tracking-tight">
            A ride for every
            <span className="bg-gradient-to-r from-[#0072c6] to-[#66c2ff] bg-clip-text text-transparent"> kind of trip.</span>
          </h1>
          <p className="text-white/60 text-lg mt-6 max-w-2xl">
            From a quick city hop to an outstation trip, pick the ride that
            fits — every fare shown upfront, no exceptions.
          </p>
        </motion.div>
      </div>
    </section>
